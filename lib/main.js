...
var lollib = function (settings) {
    ...
    if (this.endpoint) {
        console.log(
            ...
            .cyan +
            'https://github.com/alexperezpaya/irelia'.underline.blue);
    }
...
lollib.prototype.generateUrl = function (options) {
    ...
    var host = (options.region.toLowerCase() == 'euw') ? 'api.riotgames.com' : this.host;
    var result = url.format({
        protocol: (this.secure) ? 'https:' : 'http:',
        host: regionCodes[options.region] + "." + host + this.path + options.path,
        query: options.query
    });
...
lollib.prototype.getRecentGamesByAccountId = function (region, accountId, cb) {

    var url = this.generateUrl({
        region: region,
        path: 'match/v3/matchlists/by-account/' + accountId + '/recent'
    });
...
lollib.prototype.getLeagueBySummonerId = function (region, summonerId, cb) {
    ...
    var url = this.generateUrl({
        region: region,
        path: 'league/v3/leagues/by-summoner/' + summonerId
    });
...
lollib.prototype.getChampionMastery = function (region, summonerId, championId, cb) {

    var url = this.generateUrl({
        region: region,
        path: "champion-mastery/v3/champion-masteries/by-summoner/" + summonerId + "/by-champion/" + championId
    });
    this.makeRequest(url, cb);
...
lollib.prototype.getAllMasteries = function (region, summonerId, cb) {

    var url = this.generateUrl(
        {
            region: region,
            path: "champion-mastery/v3/champion-masteries/by-summoner/" + summonerId
        });
    this.makeRequest(url,cb);
	
};

lollib.prototype.getTotalChampionMasteries = function (region, summonerId, championId,cb) {

    var url = this.generateUrl(
        {
            region: region,
            path: "champion-mastery/v3/scores/by-summoner/" + summonerId
        });
    this.makeRequest(url,cb);
...
lollib.prototype.getAllChampionMasteries = function (region, summonerId, cb) {
...
<<<<<<< HEAD
    ...
    this.makeRequest(url, cb);
=======
        path: 'league/v3/positions/by-summoner/' + summonerId
	});
>>>>>>> origin/master

};

lollib.prototype.getTotalChampionMasteries = function (region, summonerId, cb) {
...
=======
	var url = this.generateUrl({
		region: region,
        path: 'league/v3/challengerleagues/by-queue/' + type,
		query: {
			type: type
		}
	});
...
<<<<<<< HEAD
    var url = this.generateUrl({
        region: region,
        path: 'platform/v3/masteries/by-summoner/' + summonerId
    });
=======
	var url = this.generateUrl({
		region: region,
...
<<<<<<< HEAD
    var url = this.generateUrl({
        region: region,
        path: 'platform/v3/runes/by-summoner/' + summonerId
    });
=======
	var url = this.generateUrl({
		region: region,
...
<<<<<<< HEAD
    var url = this.generateUrl({
        region: region,
        path: 'summoner/v3/summoners/by-name/' + name
    });
...
<<<<<<< HEAD
    var url = this.generateUrl({
        region: region,
        path: 'summoner/v3/summoners/' + summonerId
    });
=======
	var url = this.generateUrl({
		region: region,
...
lollib.prototype.getMatchByMatchId = function (region, matchId, cb){

	var url = this.generateUrl({
		region: region,
        	path: 'match/v3/matches/' + matchId
	});
...
lollib.prototype.getRankedMatchesByAccountId = function (region, accountId, cb){

	var url = this.generateUrl({
		region: region,
        	path: 'match/v3/matchlists/by-account/' + accountId
	});
...
lollib.prototype.getRecentMatchesByAccountId = function (region, accountId, cb){
...
lollib.prototype.getStatus = function (region, cb){

	var url = this.generateUrl({
		region: region,
        	path: 'status/v3/shard-data'
	});
>>>>>>> origin/master
