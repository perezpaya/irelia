...
lollib.prototype.getChampionMastery = function (region, summonerId, championId,cb){
	...
	var url = "https://" + region + "1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/" + String(summonerId) + "/by-champion/" + String(championId) + "?api_key=" + this.key;	
	this.makeRequest(url,cb);
