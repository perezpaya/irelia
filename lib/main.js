...
lollib.prototype.getRecentGamesBySummonerId = function (region, summonerId, cb){
	...
	var url = this.endpoint + region + '/v1.3/game/by-summoner/' + summonerId + '/recent?api_key=' + this.key; 
	this.makeRequest(url, cb);
...
lollib.prototype.getLeagueBySummonerId = function (region, summonerId, cb){
	...
	var url = this.endpoint + region + '/v2.3/league/by-summoner/' + summonerId + '?api_key=' + this.key; 
	this.makeRequest(url, cb);
...
lollib.prototype.getMasteriesBySummonerId = function (region, summonerId, cb) {
	...
	var url = this.endpoint + region + '/v1.3/summoner/' + summonerId + '/masteries?api_key=' + this.key; 
	this.makeRequest(url, cb);
...
lollib.prototype.getRunesBySummonerId = function (region, summonerId, cb) {
	...
	var url = this.endpoint + region + '/v1.3/summoner/' + summonerId + '/runes?api_key=' + this.key; 
	this.makeRequest(url, cb);
...
lollib.prototype.getSummonerByName = function (region, name, cb){
	...
	var url = this.endpoint + region + '/v1.3/summoner/by-name/' + name + '?api_key=' + this.key; 
	this.makeRequest(url, cb);
...
lollib.prototype.getSummonerBySummonerId = function (region, summonerId, cb){
	...
	var url = this.endpoint + region + '/v1.3/summoner/' + summonerId + '?api_key=' + this.key; 
	this.makeRequest(url, cb);
...
lollib.prototype.getNamesBySummonerIds = function (region, summonerIds, cb){
	...
	var url = this.endpoint + region + '/v1.3/summoner/' + summonerIds.join(',') + '?api_key=' + this.key; 
	this.makeRequest(url, cb);
