...
lollib.prototype.getChampionMastery = function (region, summonerId, championId,cb){
	...
	var url = region + "1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/" + String(summonerId) + "/by-champion/ + String(championId) + "?api_key=" + "RGAPI-323C1392-BEDB-4D03-85EC-4DE4B417E253";	
	this.makeRequest(url,cb);
